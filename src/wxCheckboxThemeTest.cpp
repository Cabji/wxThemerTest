    ...
    : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(400, 300))
{
    ...
    m_button = new wxButton(m_panel, wxID_ANY, m_arrayThemeNames[m_themeIndex], wxDefaultPosition, wxDefaultSize, wxBORDER_RAISED);
    m_flexGridSizer->Add(m_staticText, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL);
    m_flexGridSizer->Add(m_checkBox, 1, wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL);
    m_flexGridSizer->Add(m_button, 2, wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL);
